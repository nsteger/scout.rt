...
/**
 * @param config An object with 2 properties: property, constType
 */
export function resolveConstProperty(object: PlainObject, config: { property: string; constType: string }) {
