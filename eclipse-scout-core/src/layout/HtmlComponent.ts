...
export default class HtmlComponent {
  ...
  protected _checkValidationPossible() {
   ...
   * @exception When component has no layout
   */
  prefSize(options?: object | boolean) {
    if (!this.isVisible()) {
   ...
   */
  protected _adjustSizeHintsForPrefSize(options, minSize, maxSize) {
   ...
   */
  protected _adjustPrefSizeWithMinMaxSize(prefSize, minSize, maxSize) {
